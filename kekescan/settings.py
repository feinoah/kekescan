...
# flower api接口地址
FLOWER_API = "http://bigfishlawyer.com:5555/api"
...
#BROKER_URL = 'django://'
#CELERY_RESULT_BACKEND = 'db+mysql://root:wenjunnengyoujiduochou@127.0.0.1:3306/'

#rabbitmq
"""
CELERY_BROKER_URL = 'redis://:xx@xx/1'
...
ROOT_URLCONF = 'kekescan.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'kekescan.wsgi.application'
